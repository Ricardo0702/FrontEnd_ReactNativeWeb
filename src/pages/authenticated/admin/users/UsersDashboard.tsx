...
const UsersDashboard: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal title={t('title.confirm.delete')} visible={deleteModal} onClose={cancelDeleteUser} size="xxs" position="center">
        <Text style={{ marginBottom: 20, alignSelf: 'center', color: colors.text }}> {t('confirm.delete.message.user')} </Text>
        <View style={{ flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Button title={t('button.delete')} size="xxs" color={colors.whiteText} style={[styles.confirmButton, {backgroundColor: colors.darksteel}]}
            onPress={() => confirmDeleteUser(selectedDeleteUserId)} 
          />
        </View>
      </Modal>
    </View>
